...
const Header = () => {
  ...
  const { logout, user, isLoggedIn } = useAuth(); // Removed isLoading
    ...
    <nav className="sticky top-0 z-50 text-gray-900 dark:text-white bg-opacity-20 backdrop-blur-lg">
      ...
      {menuOpen && (
        <div className="fixed inset-0 z-50">
          <div className="fixed right-0 top-0 h-full w-1/2 border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 text-gray-900 dark:text-white overflow-y-auto">
