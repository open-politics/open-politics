...
const tiers = [
  { 
    ...
    icon: Users,
    features: [
      { name: "Full hosted Webapp functionality", included: true },
  ...
  },
  {
    ...
    description: "For grant-financed institutions and philanthropic projects",
    subDescription: {
      who: "Grant-funded organizations, NGOs, and philanthropic projects",
      features: [
        "Direct assistance with grant applications",
    ...
    features: [
      ...
      { name: "Grant application assistance", included: true },
      { name: "Custom training & onboarding", included: true },
      { name: "Infrastructure support (optional)", included: true },
    ],
    apiKeys: "Bring your own AI/LLM API keys or discuss managed options",
    cta: "Contact Us",
  },
  {
    ...
    subDescription: {
      who: "Commercially active organizations (e.g., agencies, private think tanks, consulting firms)",
    ...
    <section className="py-20">
      <div className="container mx-auto">
        ...
        >
          ...
          <p className="text-xl">
            Choose the plan that's right for you and start leveraging the power of Open Politics.
          </p>
        </motion.div>
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-16">
            {[tiers[0], tiers[2]].map((tier, index) => (
              <motion.div
                key={tier.name}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                ...
                {index === 0 ? (
                  <div className="relative h-full">
                    ...
                    <div className="absolute -inset-4 pointer-events-none z-10">
                      ...
                      <FloatingSparkle className="absolute top-1/3 -right-2" style={{ animationDelay: '0.3s' }}>✨</FloatingSparkle>
                      <FloatingSparkle className="absolute bottom-8 left-8" style={{ animationDelay: '0.1s' }}>✨</FloatingSparkle>
                    </div>
                    <GlowingCard
              ...
              >
                {index === 0 ? (
                  <div className="relative h-full">
                    ...
                    <div className="absolute -inset-4 pointer-events-none z-10">
                      <FloatingSparkle className="absolute top-0 left-4" style={{ animationDelay: '0.5s' }}>✨</FloatingSparkle>
                      <FloatingSparkle className="absolute top-1/3 -right-2" style={{ animationDelay: '0.1s' }}>✨</FloatingSparkle>
                      <FloatingSparkle className="absolute bottom-8 left-8" style={{ animationDelay: '0.8s' }}>✨</FloatingSparkle>
                    </div>
                    <GlowingCard
