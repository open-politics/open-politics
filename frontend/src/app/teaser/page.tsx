      ...
      <div className="container relative mx-auto px-4 mt-0 min-h-screen max-w-full overflow-x-hidden">
        ...
        <motion.div
          ...
          animate={isBrowseMode ? (
            ...
            getWindowWidth() < 768 ? 
              // Browse Mode on mobile
              { width: 'full', top: 'calc(50% + 100px)', left: '50%', transform: 'translate(-50%, 0)', zIndex: "100" } :
              // Browse Mode on desktop
            ...
            getWindowWidth() < 768 ? 
              // Detail Mode on mobile
              { width: '80%', top: '150px', left: '50%', transform: 'translate(-50%, 0)' } :
              // Detail Mode on desktop
