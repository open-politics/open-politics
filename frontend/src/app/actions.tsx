import {
  ...
  import { UserMessage } from '@/components/collection/user-message'
  import { SearchSection } from '@/components/collection/search-section'
  import SearchRelated from '@/components/collection/search-related'
  import { CopilotDisplay } from '@/components/collection/copilot-display'
  import RetrieveSection from '@/components/collection/retrieve-section'
  import { VideoSearchSection } from '@/components/video-search-section'
  import { AnswerSection } from '@/components/collection/answer-section'
